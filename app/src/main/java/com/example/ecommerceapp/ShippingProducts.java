...
public class ShippingProducts extends AppCompatActivity {

    ListView lsvShippingProducts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shipping_products);
        initComponents();
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot data: dataChildren){
                    ...
                    if(s.getStatus().equals("shipping"))
                        mArrayList.add(s);
                    //Log.d("List","List length: "+ studentList.size());

                    Log.d("Products: ",s.getStatus() );
                }
                lsvShippingProducts.setAdapter(pendingAdapter);
            }
    ...
    private void initComponents() {
        lsvShippingProducts = findViewById(R.id.lsvShippingProducts);
    }
}
