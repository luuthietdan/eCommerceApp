...
public class GettingProducts extends AppCompatActivity {

    ListView lsvGettingProducts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_getting_products);
        initComponents();
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot data: dataChildren){
                    ...
                    if(s.getStatus().equals("getting"))
                        mArrayList.add(s);
                    //Log.d("List","List length: "+ studentList.size());

                    Log.d("Products: ",s.getStatus() );
                }
                lsvGettingProducts.setAdapter(pendingAdapter);
            }
    ...
    private void initComponents() {
        lsvGettingProducts = findViewById(R.id.lsvGettingProducts);
    }
}
